...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.12.0"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.26.16"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.26.16"
