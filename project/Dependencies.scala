...
object Dependencies {
  ...
  lazy val notifyJavaClient: ModuleID = "uk.gov.service.notify" % "notifications-java-client" % "5.2.0-RELEASE" 
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.13.0"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.26.31"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.26.31"
