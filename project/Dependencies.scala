...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.7.1"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.23.19"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.23.19"
