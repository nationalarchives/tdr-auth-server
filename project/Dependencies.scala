...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.13.0.CR1"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.26.24"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.26.24"
