...
object Dependencies {
  ...
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.25.57"
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.10.1"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.25.57"
