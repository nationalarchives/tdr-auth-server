...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.7.3"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.24.9"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.24.9"
