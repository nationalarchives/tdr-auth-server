...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.8.3"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.25.15"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.25.15"
