...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.7.4"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.24.4"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.24.4"
