...
object Dependencies {
  ...
  lazy val quarkusCredentials = "io.quarkus" % "quarkus-credentials" % "3.8.0"
  lazy val rds = "software.amazon.awssdk" % "rds" % "2.25.1"
  ...
  lazy val snsSdk = "software.amazon.awssdk" % "sns" % "2.25.1"
